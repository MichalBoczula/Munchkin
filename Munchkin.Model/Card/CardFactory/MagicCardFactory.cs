    ...
    public class MagicCardFactory
    {
        public ActionCardBase CreateMagicCard(int num)
        {
            ...
            ActionCardBase result = num switch
            {
                ...
                20 => new MagicWind("Magic Wind", CardType.Special),
                21 => new Titan("Titan", CardType.Special),
                22 => new LikeAGod("Like A God", CardType.Special),
                23 => new Undead("Undead", CardType.Special),
                24 => new SecondLifeForMonster("Second Life For Monster", CardType.Special),
                25 => new Crook("Crook", CardType.Special),
                26 => new Crook("Crook", CardType.Special),
                27 => new ItemFairy("Item Fairy", CardType.Curse, random),
                28 => new Gambling("Gambling", CardType.Curse, random),
                29 => new DrunkCurse("Item Fairy", CardType.Curse, random),
                30 => new WhatAMess("Item Fairy", CardType.Curse, random),
