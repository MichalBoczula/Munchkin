...
{
    public class BackToSchool : ActionCardBase
    {
        public BackToSchool(string name, CardType cardType) : base(name, cardType)
        {
        ...
        {
            return "Curse decrease user level by 1 point";
        }
    }
}
